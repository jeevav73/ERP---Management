...
import { fetchVisitorsEnquiry } from "../../../features/visitorEnquirySlice";
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {/* <Field label="Whom to meet" value={item.whomToMeet} /> */}
...
const NormalEnquiry = () => {
  ...
  const { data = [], loading } = useSelector((state) => state.visitorsEnquiry);
  ...
  useEffect(() => {
    dispatch(fetchVisitorsEnquiry());
  }, [dispatch]);

  // const filtered = data.filter((d) =>
  //   [d.visitorId?.name, d.purpose].some((v) =>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            <h2 className="text-sm font-medium">Visitor Enquiries</h2>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50 text-left">
              {["Visitor", "Phone", "Check-in", "Purpose", "Action"].map((h) => (
                <th
                  key={h}
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2.5">
                        <div
                          className={`w-8 h-8 rounded-full ${c.bg} ${c.text} flex items-center justify-center text-xs font-medium shrink-0`}
                        >
                          {initials(v.name)}
                        </div>
